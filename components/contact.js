...
import { Mail, Phone, MapPin, Clock, Sparkles, ArrowRight, HelpCircle, Building2 } from 'lucide-react'
    ...
    <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
            ...
            <div className="contact-card group bg-white border border-slate-200 rounded-2xl p-8 text-center hover:border-rockhill-pine hover:shadow-2xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-600 font-light space-y-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {/* Denver Location */}
                ...
                <p className="text-slate-600 mb-4 font-light leading-relaxed">
                  Our main headquarters located in the heart of Denver, with easy access to Rocky Mountain adventures.
                </p>
                <div className="text-slate-700 font-medium space-y-1 bg-[#FFF3E6]/50 p-4 rounded-xl">
                  <div>456 Adventure Lane</div>
                  <div>Denver, CO 80202</div>
                  <a href="tel:+13035550100" className="text-rockhill-sunset-dark hover:text-rockhill-sunset-dark inline-flex items-center gap-1">
                    (303) 555-0100
              ...
              {/* Jackson Hole Location */}
                ...
                <p className="text-slate-600 mb-4 font-light leading-relaxed">
                  Our western base camp, perfectly positioned for mountaineering and extreme sports adventures.
                </p>
                <div className="text-slate-700 font-medium space-y-1 bg-[#FFF3E6]/50 p-4 rounded-xl">
                  <div>789 Powder Lane</div>
                  <div>Jackson, WY 83001</div>
                  <a href="tel:+13075550200" className="text-rockhill-sunset-dark hover:text-rockhill-sunset-dark inline-flex items-center gap-1">
                    (307) 555-0200
                    <ArrowRight className="w-3 h-3" />
                  </a>
                </div>
      ...
      <section className="py-24 bg-gradient-to-br from-rockhill-pine via-rockhill-pine to-rockhill-pine-dark text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <a href="mailto:offic.roll@gmail.com" className="group inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-rockhill-sunset-dark font-semibold rounded-xl hover:bg-[#FFF3E6] transition-all shadow-xl hover:shadow-2xl hover:scale-105">
            Send us an Email
